...
# pollster main app jsto ko setting folder ma aayera, tala ko first line
# basically, it will have to refer to polls ( or sano) ko apps.py ko className tyo ho Polls.config
